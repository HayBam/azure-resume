...
export default function ProjectCard({ project }: { project: Project }) {
  return (
    <div className="group relative bg-theme-surface border border-theme rounded-xl p-6 card-hover transition-colors duration-300">
      ...
      <div className="relative">
        <div className="flex items-start justify-between mb-4">
          <h3 className="text-lg font-semibold text-theme-primary group-hover:text-primary-400 transition-colors pr-4">
            {project.title}
          </h3>
          <a
            ...
            className="text-theme-muted hover:text-primary-400 transition-colors shrink-0"
        ...
        <div className="flex flex-wrap gap-2 mb-5">
          ...
          {project.technologies.length > 5 && (
            <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium text-theme-muted">
              +{project.technologies.length - 5}
            </span>
          )}
        </div>
