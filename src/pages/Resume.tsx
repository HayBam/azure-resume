    ...
    <div className="py-16 sm:py-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-12 gap-4">
          <div>
            <h1 className="text-3xl sm:text-4xl font-bold text-white mb-2">Resume</h1>
            <p className="text-gray-400">Professional experience and qualifications</p>
          </div>
          <a
            href="/resume.pdf"
            download
        ...
        <section className="mb-16">
          ...
          <div className="space-y-8">
            {resumeData.experience.map((job, index) => (
              <div
                key={index}
                className="relative pl-8 border-l-2 border-gray-800 hover:border-primary-500/50 transition-colors"
              >
                <div className="absolute left-[-9px] top-0 w-4 h-4 rounded-full bg-gray-800 border-2 border-primary-500" />
                <div className="pb-2">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {resumeData.certifications.map((cert) => (
              <div
                key={cert.name}
                className="p-4 rounded-xl bg-gray-900/50 border border-gray-800/50 hover:border-primary-500/30 transition-colors"
              >
